<html>
	...
	<body>
		...
		<div class="up" id="up">
				...
				<img height="25%" width="1.6%" src="images/phone.png" style="height:auto;"><font style="font-size:1.254vw;">&ensp;+91-6396972716&emsp;</font>
				<img height="21%" width="1.9%" src="images/message.png" style="height:auto;"><font style="font-size:1.254vw;">&ensp;brijeshpanwar122@gmail.com</font></div>
				<div class="logo1"><center><img  src="images/wheelzonrent-logo.png" height="50%" width="30%"></center>
					<div class="call"><img height="25%" width="2.5%" src="images/phone.png" style="height:auto;"><font>+91-6396972716&emsp;</font></div>
					<div class="mail"><img height="21%" width="2.5%" src="images/message.png" style="height:auto;"><font>&ensp;brijeshpanwar122@gmail.com</font></div></div>
			<nav>		
				<ul>
		...
		<div class="head">
			...
			<br>    
            <font>We provides car on rent for conferences and boared meeting in uttarakhand</font>
        </div>
        </header>
        <br> <br> <br >
        ...
        <footer>
			...
			<table>
				...
				<tr bgcolor="#252525">
					...
					<td class="widget">
						<p class="text1">Address: Dehradun Uttarakhand,India<br>
						<img src="images/phone.png">&emsp;+91-6397972716<br>
						<img src="images/message.png">&emsp;brijeshpanwar122@gmail.com</p>
					</td>
				</tr>
				<tr bgcolor="black">
